...
@protocol SWGFloodZone
@end

@interface SWGFloodZone : SWGObject
...
@property(nonatomic) SWGPrimaryZone* primaryZone;

@property(nonatomic) SWGBaseFloodElevation* baseFloodElevation;
