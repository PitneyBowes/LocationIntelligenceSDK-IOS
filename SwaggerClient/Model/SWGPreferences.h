...
@protocol SWGPreferences
@end

@interface SWGPreferences : SWGObject


@property(nonatomic) NSString* returnAllCandidateInfo;
...
@property(nonatomic) SWGFieldsMatching* mustMatchFields;

@property(nonatomic) SWGReturnFieldsDescriptor* returnFieldsDescriptor;
