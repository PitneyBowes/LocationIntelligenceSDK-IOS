...
@protocol SWGGeoRouteResponse
@end

@interface SWGGeoRouteResponse : SWGObject
...
@property(nonatomic) SWGRouteGeometry* geometry;

@property(nonatomic) SWGRouteDirections* routeDirections;
