...
@interface SWGLIAPIGeoTaxServiceApi: NSObject <SWGApi>

extern NSString* kSWGLIAPIGeoTaxServiceApiErrorDomain;
extern NSInteger kSWGLIAPIGeoTaxServiceApiMissingParamErrorCode;
