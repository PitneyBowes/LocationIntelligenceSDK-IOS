#import "SWGLIAPIGeoEnhanceServiceApi.h"
...
@interface SWGLIAPIGeoEnhanceServiceApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGLIAPIGeoEnhanceServiceApi

NSString* kSWGLIAPIGeoEnhanceServiceApiErrorDomain = @"SWGLIAPIGeoEnhanceServiceApiErrorDomain";
NSInteger kSWGLIAPIGeoEnhanceServiceApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGLIAPIGeoEnhanceServiceApi *sharedAPI;
...
-(NSNumber*) getAddressWithLatitude: (NSString*) latitude
    ...
    if (latitude == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGLIAPIGeoEnhanceServiceApiErrorDomain code:kSWGLIAPIGeoEnhanceServiceApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGLocations*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGLocations*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getPlaceByLocationWithLongitude: (NSString*) longitude
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPlaceByLocations*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPlaceByLocations*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getTimezoneByLocationWithTimestamp: (NSString*) timestamp
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGTimezone*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGTimezone*)data, error);
                                }
                           }
          ];
}
