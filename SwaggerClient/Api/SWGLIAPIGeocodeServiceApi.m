#import "SWGLIAPIGeocodeServiceApi.h"
...
@interface SWGLIAPIGeocodeServiceApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGLIAPIGeocodeServiceApi

NSString* kSWGLIAPIGeocodeServiceApiErrorDomain = @"SWGLIAPIGeocodeServiceApiErrorDomain";
NSInteger kSWGLIAPIGeocodeServiceApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGLIAPIGeocodeServiceApi *sharedAPI;
...
///
///  @returns SWGGeocodeServiceResponse*
///
-(NSNumber*) geocodeWithDatapackBundle: (NSString*) datapackBundle
    ...
    if (datapackBundle == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGLIAPIGeocodeServiceApiErrorDomain code:kSWGLIAPIGeocodeServiceApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGGeocodeServiceResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGGeocodeServiceResponse*)data, error);
                                }
                           }
          ];
}
...
///
///  @returns SWGGeocodeServiceResponseList*
///
-(NSNumber*) geocodeBatchWithDatapackBundle: (NSString*) datapackBundle
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGGeocodeServiceResponseList*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGGeocodeServiceResponseList*)data, error);
                                }
                           }
          ];
}
...
///  @param country Country name or ISO code. (optional, default to USA)
///
///  @returns SWGGeocodeCapabilitiesResponse*
///
-(NSNumber*) getCapabilitiesWithDatapackBundle: (NSString*) datapackBundle
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGGeocodeCapabilitiesResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGGeocodeCapabilitiesResponse*)data, error);
                                }
                           }
          ];
}
...
///
///  @returns SWGConfiguredDictionaryResponse*
///
-(NSNumber*) getDictionariesWithDatapackBundle: (NSString*) datapackBundle
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGConfiguredDictionaryResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGConfiguredDictionaryResponse*)data, error);
                                }
                           }
          ];
}
