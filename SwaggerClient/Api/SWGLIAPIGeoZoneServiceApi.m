#import "SWGLIAPIGeoZoneServiceApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGTravelBoundaries.h"


@interface SWGLIAPIGeoZoneServiceApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGLIAPIGeoZoneServiceApi

NSString* kSWGLIAPIGeoZoneServiceApiErrorDomain = @"SWGLIAPIGeoZoneServiceApiErrorDomain";
NSInteger kSWGLIAPIGeoZoneServiceApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGLIAPIGeoZoneServiceApi *sharedAPI;
...
-(NSNumber*) getTravelBoundaryByDistanceWithCosts: (NSString*) costs
    ...
    if (costs == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGLIAPIGeoZoneServiceApiErrorDomain code:kSWGLIAPIGeoZoneServiceApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGTravelBoundaries*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGTravelBoundaries*)data, error);
                                }
                           }
          ];
}
