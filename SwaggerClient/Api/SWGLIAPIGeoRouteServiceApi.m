#import "SWGLIAPIGeoRouteServiceApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGGeoRouteResponse.h"
#import "SWGTravelCostMatrixResponse.h"


@interface SWGLIAPIGeoRouteServiceApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGLIAPIGeoRouteServiceApi

NSString* kSWGLIAPIGeoRouteServiceApiErrorDomain = @"SWGLIAPIGeoRouteServiceApiErrorDomain";
NSInteger kSWGLIAPIGeoRouteServiceApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGLIAPIGeoRouteServiceApi *sharedAPI;
...
-(NSNumber*) getRouteByAddressWithStartAddress: (NSString*) startAddress
    ...
    if (startAddress == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGLIAPIGeoRouteServiceApiErrorDomain code:kSWGLIAPIGeoRouteServiceApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/georoute/v1/route/byaddress"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGGeoRouteResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGGeoRouteResponse*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getRouteByLocationWithStartPoint: (NSString*) startPoint
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/georoute/v1/route/bylocation"];
...
///  @param historicTrafficTimeBucket Specifies whether routing calculation uses the historic traffic speeds. (optional, default to None)
///
///  @returns SWGTravelCostMatrixResponse*
///
-(NSNumber*) getTravelCostMatrixByAddressWithStartAddresses: (NSString*) startAddresses
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/georoute/v1/travelcostmatrix/byaddress"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGTravelCostMatrixResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGTravelCostMatrixResponse*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getTravelCostMatrixByLocationWithStartPoints: (NSString*) startPoints
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/georoute/v1/travelcostmatrix/bylocation"];
