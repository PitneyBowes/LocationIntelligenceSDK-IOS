#import "SWGLIAPIGeoSearchServiceApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGLocations.h"


@interface SWGLIAPIGeoSearchServiceApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGLIAPIGeoSearchServiceApi

NSString* kSWGLIAPIGeoSearchServiceApiErrorDomain = @"SWGLIAPIGeoSearchServiceApiErrorDomain";
NSInteger kSWGLIAPIGeoSearchServiceApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGLIAPIGeoSearchServiceApi *sharedAPI;
...
-(NSNumber*) geoSearchWithSearchText: (NSString*) searchText
    ...
    if (searchText == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGLIAPIGeoSearchServiceApiErrorDomain code:kSWGLIAPIGeoSearchServiceApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
