...
NSString *const kGeoSearchLocation = @"location";
...
- (instancetype)initWithDictionary:(NSDictionary *)dict
{
    ...
    NSObject *receivedLocation = [dict objectForKey:kGeoSearchLocation];
...
- (NSDictionary *)dictionaryRepresentation
{
    ...
    [mutableDict setValue:[NSArray arrayWithArray:tempArrayForLocation] forKey:kGeoSearchLocation];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    self.location = [aDecoder decodeObjectForKey:kGeoSearchLocation];
    return self;
}
...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:_location forKey:kGeoSearchLocation];
}

- (id)copyWithZone:(NSZone *)zone
{
    GeoSearch *copy = [[GeoSearch alloc] init];
