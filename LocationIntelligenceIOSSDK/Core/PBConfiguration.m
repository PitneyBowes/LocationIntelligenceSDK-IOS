...
@implementation PBConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static PBConfiguration *shardConfig = nil;
...
- (instancetype) init {
    ...
    if (self) {
        self.apiClient = nil;
        self.host = @"https://api.pitneybowes.com/location-intelligence";
        self.username = @"";
        self.password = @"";
        self.accessToken= @"";
        self.verifySSL = YES;
        ...
        self.mutableDefaultHeaders[@"User-Agent"] = [NSString stringWithFormat:@"Swagger-Codegen/3.6.0/objc (%@; iOS %@; Scale/%0.2f)",[[UIDevice currentDevice] model], [[UIDevice currentDevice] systemVersion], [[UIScreen mainScreen] scale]];
        self.logger = [PBLogger sharedLogger];
        self.oAuthTokenURL=@"https://api.pitneybowes.com/oauth/token";
    }
    return self;
}
