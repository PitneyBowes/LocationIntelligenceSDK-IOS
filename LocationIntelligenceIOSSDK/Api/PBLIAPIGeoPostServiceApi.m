#import "PBLIAPIGeoPostServiceApi.h"
...
@interface PBLIAPIGeoPostServiceApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation PBLIAPIGeoPostServiceApi

NSString* kPBLIAPIGeoPostServiceApiErrorDomain = @"PBLIAPIGeoPostServiceApiErrorDomain";
NSInteger kPBLIAPIGeoPostServiceApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static PBLIAPIGeoPostServiceApi *sharedAPI;
...
///
///  @returns PBCarrierRouteResponse*
///
-(NSNumber*) getCarrierRoutesByAddressWithAddress: (NSString*) address
    ...
    if (address == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kPBLIAPIGeoPostServiceApiErrorDomain code:kPBLIAPIGeoPostServiceApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/geopost/v1/carrierroute/byaddress"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"PBCarrierRouteResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((PBCarrierRouteResponse*)data, error);
                                }
                           }
          ];
}
...
///  @param body  (optional)
///
///  @returns PBCarrierRouteResponseList*
///
-(NSNumber*) getCarrierRoutesByAddressBatchWithBody: (PBCarrierRouteAddressRequest*) body
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"PBCarrierRouteResponseList*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((PBCarrierRouteResponseList*)data, error);
                                }
                           }
          ];
}
