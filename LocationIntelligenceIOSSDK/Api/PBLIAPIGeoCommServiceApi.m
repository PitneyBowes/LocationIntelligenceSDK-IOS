#import "PBLIAPIGeoCommServiceApi.h"
#import "PBQueryParamCollection.h"
#import "PBRateCenterResponse.h"


@interface PBLIAPIGeoCommServiceApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation PBLIAPIGeoCommServiceApi

NSString* kPBLIAPIGeoCommServiceApiErrorDomain = @"PBLIAPIGeoCommServiceApiErrorDomain";
NSInteger kPBLIAPIGeoCommServiceApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static PBLIAPIGeoCommServiceApi *sharedAPI;
...
-(NSNumber*) getRateCenterByAddressWithAddress: (NSString*) address
    ...
    if (address == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kPBLIAPIGeoCommServiceApiErrorDomain code:kPBLIAPIGeoCommServiceApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
