#import "PBLIAPIGeo911ServiceApi.h"
#import "PBQueryParamCollection.h"
#import "PBAHJPlusPSAPResponse.h"
#import "PBPSAPResponse.h"


@interface PBLIAPIGeo911ServiceApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation PBLIAPIGeo911ServiceApi

NSString* kPBLIAPIGeo911ServiceApiErrorDomain = @"PBLIAPIGeo911ServiceApiErrorDomain";
NSInteger kPBLIAPIGeo911ServiceApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static PBLIAPIGeo911ServiceApi *sharedAPI;
...
-(NSNumber*) getAHJPlusPSAPByAddressWithAddress: (NSString*) address
    ...
    if (address == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kPBLIAPIGeo911ServiceApiErrorDomain code:kPBLIAPIGeo911ServiceApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
