...
@interface PBLIAPIGeoEnhanceServiceApi: NSObject <PBApi>

extern NSString* kPBLIAPIGeoEnhanceServiceApiErrorDomain;
extern NSInteger kPBLIAPIGeoEnhanceServiceApiMissingParamErrorCode;
