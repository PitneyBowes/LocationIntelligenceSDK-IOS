...
@protocol PBTaxRateBatchLocationResponse
@end

@interface PBTaxRateBatchLocationResponse : PBObject
...
@property(nonatomic) PBSalesTaxRate* salesTax;

@property(nonatomic) PBUseTaxRate* useTax;
